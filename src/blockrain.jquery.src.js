((function ( $ ) {
  ...
  $.widget('aerolab.blockrain', {
    ...
    options: {
      ...
      // Copy
      playText: 'Aqui va titulo empresa o cualquier texto',
      playButtonText: 'Juega',
      playMachineText: 'PC',
      gameOverText: 'Game Over',
      restartButtonText: 'Jugar de nuevo',
      scoreText: 'Score',
    ...
    //Poder jugar contra la maquina
      
    _doStartMachine: function() {
     console.log("do start machine");
    ...
    _createUI: function() {
      ...
      game._$start = $(
        '<div class="blockrain-start-holder" style="position:absolute;">'+
          '<div class="blockrain-start">'+
            ...
            '<a class="blockrain-btn blockrain-start-machinebtn" style="style="position:relative !important;">'+ this.options.playMachineText + '</a>'+
          '</div>'+
        '</div>').hide();
      ...
      game._$start.find('.blockrain-start-btn').click(function(event){
       ...
       game._$start.find('.blockrain-start-machinebtn').click(function(event){
        console.log("maquina");
        event.preventDefault();
        game.startMachine();
      });    
      ...
      game._$gameover.find('.blockrain-game-over-btn').click(function(event){
        ...
        game._$gameover.find('.blockrain-start-machinebtn').click(function(event){
          event.preventDefault();
          game.restartMachine();
        });
